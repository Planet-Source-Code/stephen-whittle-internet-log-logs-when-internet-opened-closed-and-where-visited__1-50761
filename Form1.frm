...
Open "c:\internet log.txt" For Append As #1
      Print #1, "Program closed  " & Date & "  " & Time
      Close #1
...
Private Sub Timer2_Timer()
 ...
 If List1.list(List1.ListCount - 1) <> Mid$(Label2.Caption, 2, InStr(10, Label2.Caption, "/") - 2) Then
   List1.AddItem Mid$(Label2.Caption, 2, InStr(10, Label2.Caption, "/") - 2)
   Open "c:\internet log.txt" For Append As #1
      Print #1, Mid$(Label2.Caption, 2, InStr(10, Label2.Caption, "/") - 2)
      Close #1
 End If
